<template>
  <main class="home">
    ...
    <section class="center" role="main">
      <h1 class="title">往日深渊的咏叹者 · 弗洛洛</h1>
    ...
    >
      <div class="inner container">
        <div class="center">
          <div class="slogan">音符终将消散，但失亡彼岸的回响永恒</div>
          <div class="meta">
            © <span>{{ year }}</span> 弗洛洛电子设定集 · 制作：霜落天亦
          </div>
        </div>
      </div>
    </footer>
...
$bg-deep: #06050a; // 极深的暗底（夜色 / 湮灭）
$deep-2: #110717; // 次深色用于下方渐变
$accent-1: #b86be0; // 暗紫主光（优雅、冷峻）
$accent-2: #ff6b85; // 血玫高光（情感/血泪点缀）
$muted-text: #efe9ec; // 苍白文字（偏冷）
$glass: rgba(184, 107, 224, 0.06);
$soft-blood: rgba(255, 107, 133, 0.04);
...
.home {
  ...
  .carousel {
    ...
    &::before {
      ...
      animation: staff-scroll 14s linear infinite;
      pointer-events: none;
    }
    ...
    .carousel-image {
      ...
      /* 降饱和、加暗与轻微模糊，更符湮灭感 */
      filter: blur(0.6px) saturate(0.75) contrast(0.95) brightness(0.9);
  ...
  .center {
    ...
    .title {
      ...
      text-shadow: 0 10px 38px rgba(8, 6, 10, 0.6),
        0 2px 6px rgba($accent-1, 0.06);
      ...
      &::after {
        ...
        box-shadow: 0 4px 16px rgba($accent-2, 0.08);
      }
    }
